      ...
      <div className="container">
        ...
        <div className='page-wrapper'>
          <Modal
            ...
            footer={null}
            centered
            width={1000} // Tăng chiều rộng của popup (có thể thay đổi giá trị này tùy nhu cầu)
          >
            {addPopupForm()}
          </Modal>
          <div className='page-head'>
            ...
            <div className='page-action'>
              ...
              <Space>
                <button className='ant-btn ant-btn-primary' onClick={saveAdmission}>Thêm</button>
